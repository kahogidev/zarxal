...
$this->title = 'Tour paket kategoriyalar';
                    ...
                    <div class="card-header flex-wrap d-flex justify-content-between  border-0 margin">
                        ...
                        <ul class="nav nav-tabs dzm-tabs" id="myTab-1" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button   class=" btn btn-secondary" ><?= Html::a("Yangi tour kategoriya yaratish", ['create'],['style' =>'color:white;font-weight:bold']) ?></button>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [ 'attribute' =>'images',
                                    'value' => function($data){
                                        $image = \app\models\StaticFunctions::getImage('tourscategory',$data->id, $data->images);
